...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='resampled_file.csv', help='data csv file')
    ...
    if args.is_training:
        ...
        torch.cuda.empty_cache()
# mse:0.0032231661025434732, mae:0.0385880284011364
# mse:0.03143812343478203, mae:0.06807404011487961
